  ...
  _.forOwn(scheme, function(subScheme, schemeKey) {
    if(_.isFunction(subScheme) === false){
      if(isOperation(schemeKey)){
        ...
        //console.log(subScheme, provider, _.result(provider, subScheme));
        ...
        /*console.log(subScheme, provider, _.result(provider, subScheme));
        console.log(subScheme.toString(), provider, _.result(provider, subScheme.toString()));
        console.log(_.result(provider, subScheme) === _.result(provider, subScheme.toString()))
        subScheme = subScheme.toString();*/
        let parsedString = parseSchemeNumber(provider, subScheme);
        if(parsedString || _.isNumber(parsedString)){
          json[schemeKey] = parsedString;
        }
